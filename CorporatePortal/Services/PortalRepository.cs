...
public class PortalRepository
{
    ...
    public PortalRepository()
    {
        ...
        [
            new PortalPage
            {
                ...
                Widgets = [new WidgetConfig{Id=1,Type="clock",Title="Часы",SortOrder=1},new WidgetConfig{Id=2,Type="date",Title="Дата",SortOrder=2}],
                LinkGroups =
                [
    ...
    private static WidgetConfig CloneWidget(WidgetConfig s)=>new(){Id=s.Id,Type=s.Type,Title=s.Title,SortOrder=s.SortOrder,IsVisible=s.IsVisible};
}
